...
export const Contato: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const mailtoUrl = `mailto:contato@cemuc.com?subject=${encodeURIComponent(
      `[Site-MUC] ${subject}`
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
          <div className="glass-panel" style={{ padding: '30px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <div style={{ display: 'flex', gap: '12px' }}>
                ...
                <div>
                  ...
                  <p style={{ color: '#94a3b8', fontSize: '0.9rem' }}>(21) 97525-9839</p>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', gap: '12px' }}>
                ...
                <div>
                  ...
                  <p style={{ color: '#94a3b8', fontSize: '0.9rem' }}>contato@cemuc.com</p>
                </div>
              </div>
            ...
            <div style={{ marginTop: '24px', display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
              <a 
                href="https://wa.me/5521975259839" 
                target="_blank" 
          ...
          <div className="glass-panel" style={{ padding: '24px', textAlign: 'center' }}>
            ...
            <a 
              href="https://maps.google.com/?q=Estrada+General+Canrobert+Pereira+da+Costa,+485+Magalhaes+Bastos+Rio+de+Janeiro" 
              target="_blank" 
              rel="noopener noreferrer" 
